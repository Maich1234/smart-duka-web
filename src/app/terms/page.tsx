...
export const metadata: Metadata = {
  title: 'Terms of Service – DuQana',
  description:
    'The agreement covering your use of DuQana: subscriptions and billing, staff seats, your data, availability, and how either side can end the agreement.',
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 lg:py-16">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 lg:p-8 space-y-8">
          <Section title="1. The agreement">
            <P>
              These terms cover your use of DuQana: the mobile app, the web app, and this website. By
          ...
          <Section title="8. Acceptable use">
            ...
            <Bullets
              items={[
                'Use DuQana for anything unlawful, or to record transactions you know to be fraudulent.',
          ...
          <Section title="9. Payments through M-Pesa">
            <P>
              ...
              credentials you supply. DuQana records those payments; it never holds your money. You are
          ...
          <Section title="10. Availability">
            <P>
              We work hard to keep DuQana running, and the app is built to keep recording sales while
          ...
          <Section title="11. Limits on liability">
            <P>
              DuQana is provided as-is. To the extent the law allows, we are not liable for lost
          ...
          <Section title="12. Changes">
            <P>
              ...
              the app before it takes effect. Continuing to use DuQana after that means you accept the
              updated terms.
            </P>
          </Section>
