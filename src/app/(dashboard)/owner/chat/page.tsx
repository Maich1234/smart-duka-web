...
/**
 * Ask DuQana — the business consultant chat.
 *
  ...
  return (
    ...
    <div className="flex flex-col h-[calc(100dvh-11rem)] min-h-[24rem] max-w-3xl mx-auto">
      <div className="flex items-start justify-between gap-3 mb-4">
        <div>
          <h1 className="text-2xl font-extrabold" style={{ color: '#0F172A' }}>Ask DuQana</h1>
      ...
      >
        <p className="text-sm text-gray-600">
          It will be removed from DuQana AI. This can&apos;t be undone.
        </p>
