...
function ReceiptSuccessModal({ sale, onClose, onNewSale }: { sale: Sale; onClose: () => void; onNewSale: () => void; }) {
...
export default function StaffSalesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {completedSale && <ReceiptSuccessModal sale={completedSale} onClose={() => setCompletedSale(null)} onNewSale={() => setCompletedSale(null)} />}
